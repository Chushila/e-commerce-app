...
function Product (props){
    ...
    if(props.info.image===null){
        props.info.image = 'https://cdn11.bigcommerce.com/s-4lc6bqzzwx/images/stencil/640w/products/6281/5426/00747479001175_front__63024.1578714655.jpg?c=1'
    }
    ...
    return(
        <div className='Product'>
           ...
           <div className = 'infoContainer'> 
            ...
            {quantityInCart.current < props.info.quantity ? <button onClick = {handleClick}></button> : <span id='OutOfStock'>Out of stock</span>}
           </div>
